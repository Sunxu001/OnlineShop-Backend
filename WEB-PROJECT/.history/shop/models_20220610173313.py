...
class Order(models.Model):
    ...
    la_name = models.CharField( max_length=50, blank=False, null=False)
...
class Goods(models.Model):
    ...
    goods_num = models.IntegerField("Inventory", default=0)
    market_price = models.FloatField("market price", default=0)
    shop_price = models.FloatField("shop price", default=0)
    goods_brief = models.TextField("Product short description", max_length=500)
